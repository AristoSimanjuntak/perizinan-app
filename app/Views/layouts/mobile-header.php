				...
				<div class="mb-1 navbar navbar-expand-lg  nav nav-item  navbar-nav-right responsive-navbar navbar-dark  ">
					<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
						...
						<div class="dropdown main-header-notification">
							...
							<div class="main-notification-list">
							   <div class="media new">
							   <div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/img/users/10.jpg'); ?>"></div>
							       <div class="media-body">
								       <p>Paul Molive <span>I'm sorry but i'm not sure how...</span>
							       </div>
							  	 </div>
							    <div class="media">
								<div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/img/users/8.jpg'); ?>"></div>
							         <div class="media-body">
							            <p>Sahar DaryAll<span> set ! Now, time to get to you now......</span>
							        </div>
							     </div>
								<div class="media">
								<div class="main-img-user online"><img alt="avatar" src="<?php echo base_url('assets/img/users/11.jpg'); ?>"></div>
									<div class="media-body">
